...
class ModelCatalogProduct extends Model {
	public function addProduct($data) {
		...
		if (isset($data['product_variation'])) {
			foreach ($data['product_variation'] as $variation_id) {
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_variation WHERE product_id = '" . (int)$product_id . "' AND variation_id = '" . (int)$variation_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_variation SET product_id = '" . (int)$product_id . "', variation_id = '" . (int)$variation_id . "'");
				$this->db->query("DELETE FROM " . DB_PREFIX . "product_variation WHERE product_id = '" . (int)$variation_id . "' AND variation_id = '" . (int)$product_id . "'");
				$this->db->query("INSERT INTO " . DB_PREFIX . "product_variation SET product_id = '" . (int)$variation_id . "', variation_id = '" . (int)$product_id . "'");
			}
		}
	...
	public function editProduct($product_id, $data) {
		...
		$this->db->query("DELETE FROM " . DB_PREFIX . "product_variation WHERE variation_id = '" . (int)$product_id . "'");
	...
	public function copyProduct($product_id) {
		...
		if ($query->num_rows) {
			...
			$data['product_variation'] = $this->getProductVariation($product_id);
	...
	public function getProductVariation($product_id) {
		...
		foreach ($query->rows as $result) {
			$product_variation_data[] = $result['variation_id'];
		}
