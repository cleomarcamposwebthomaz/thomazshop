...
class ControllerCatalogProduct extends Controller {
	...
	protected function getForm() {
		...
		if (isset($this->request->post['product_variation'])) {
			$products = $this->request->post['product_variation'];
		} elseif (!empty($product_info)) {
			$products = $this->model_catalog_product->getProductVariation($this->request->get['product_id']);
		} else {
			$products = array();
		}
		...
		foreach ($products as $product_id) {
			$variation_info = $this->model_catalog_product->getProduct($product_id);

			if ($variation_info) {
				$data['product_variations'][] = array(
					'product_id' => $variation_info['product_id'],
