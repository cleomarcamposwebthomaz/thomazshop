...
class ControllerExtensionThemeDefault extends Controller {
	...
	public function index() {
		...
		if (isset($this->error['image_variation'])) {
			$data['error_image_variation'] = $this->error['image_variation'];
		} else {
			$data['error_image_variation'] = '';
		}
		...
		if (isset($this->request->post['theme_default_image_variation_width'])) {
			$data['theme_default_image_variation_width'] = $this->request->post['theme_default_image_variation_width'];
		} elseif (isset($setting_info['theme_default_image_variation_width'])) {
			$data['theme_default_image_variation_width'] = $setting_info['theme_default_image_variation_width'];
		} else {
			$data['theme_default_image_variation_width'] = 80;
		}

		if (isset($this->request->post['theme_default_image_variation_height'])) {
			$data['theme_default_image_variation_height'] = $this->request->post['theme_default_image_variation_height'];
		} elseif (isset($setting_info['theme_default_image_variation_height'])) {
			$data['theme_default_image_variation_height'] = $setting_info['theme_default_image_variation_height'];
		} else {
			$data['theme_default_image_variation_height'] = 80;
		}
	...
	protected function validate() {
		...
		if (!$this->request->post['theme_default_image_variation_width'] || !$this->request->post['theme_default_image_variation_height']) {
			$this->error['image_variation'] = $this->language->get('error_image_variation');
		}
