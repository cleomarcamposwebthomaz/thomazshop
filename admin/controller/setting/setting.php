...
class ControllerSettingSetting extends Controller {
	...
	public function index() {
		...
		if (isset($this->request->post['config_semjuros'])) {
			$data['config_semjuros'] = $this->request->post['config_semjuros'];
		} else {
			$data['config_semjuros'] = $this->config->get('config_semjuros');
		}
		...
		if (isset($this->request->post['config_social_whatsapp'])) {
			$data['config_social_whatsapp'] = $this->request->post['config_social_whatsapp'];
		} else {
			$data['config_social_whatsapp'] = $this->config->get('config_social_whatsapp');
		}
